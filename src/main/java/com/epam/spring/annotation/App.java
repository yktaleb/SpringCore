...
import com.epam.spring.annotation.domain.Client;
import com.epam.spring.annotation.domain.Event;
import com.epam.spring.annotation.domain.EventType;
...
public class App {
    ...
    public App(@Qualifier("client") Client client,
               @Value("#{T(com.epam.spring.annotation.domain.Event).isDay() ? consoleEventLogger : cacheFileEventLogger}")
